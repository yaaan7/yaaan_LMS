    ...
    function loadAssignmentData(assignmentId) {
        fetch(`/api/assignments/${assignmentId}`)
            ...
            .then(data => {
                ...
                ClassicEditor.instances['assignment_description'].setData(data.description);
    ...
    function submitAssignment() {
        ...
        const description = document.querySelector('textarea#assignment_description').value;
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                window.location.href = '/homework/list/1';
            })
            .catch(error => {
